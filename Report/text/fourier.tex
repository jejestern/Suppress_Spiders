...
\begin{figure}[H]
	\centering
		...
		\caption{The top shows a function with four Gaussian profiles which every 90 degrees. The Fourier transform of this is shown in blue in the bottom image. Additionally we plot in green the Fourier transform of a single Gaussian profile.}
		\label{fig:Gauss_fourspyders90}
\end{figure} 

As a next step we want to include the fact, that the spyders have different widths. 
