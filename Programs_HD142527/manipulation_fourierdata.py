...
for image_name in files[0:3]:
    if image_name.endswith("1.fits"): 
        ...
        ## Fitting an exponential and subtract it from the warped data
        ...
        f_ap_f, ap_f_draw, annu_f_draw = aperture_flux_warped(warped_or, warped_shape, 
                                                              R_1, aspect_rad, 
                                                              model_planet)
        print("The aperture flux of the model planet in the warped and flattened image is: ", f_ap_f)
        ...
        ### Plot vertical and horizontal cuts throught the FFT
        y = 0
        plt.figure(figsize=(8, 16*aspect_value))
        while y < (R_2-R_1)/2:
